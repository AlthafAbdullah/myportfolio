...
function dizme_tm_modalbox() {
  ...
  jQuery(".dizme_tm_all_wrap").prepend(
    '<div class="dizme_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
...
function dizme_tm_service_popup() {
  ...
  var button = jQuery(
    ".dizme_tm_services .service_list ul li .dizme_tm_full_link"
  );
  ...
  button.on("click", function () {
    ...
    modalBox
      ...
      .after('<div class="main_title">' + title + "</div>");
    return false;
  });
...
function dizme_tm_modalbox_news() {
  ...
  var modalBox = jQuery(".dizme_tm_modalbox");
  var button = jQuery(
    ".dizme_tm_news .dizme_tm_full_link,.dizme_tm_news ul li .details .title a"
  );
  var closePopup = modalBox.find(".close");
    ...
    jQuery(this)
      .on("mouseenter", function () {
        if (jQuery(this).data("title")) {
          jQuery(".dizme_tm_portfolio_titles").html(
